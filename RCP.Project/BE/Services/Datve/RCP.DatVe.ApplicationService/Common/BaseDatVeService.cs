...
namespace RCP.DatVe.ApplicationService.Common
{
    public class BaseDatVeService
    {
        private static readonly TimeZoneInfo VietnamTimeZone = TimeZoneInfo.FindSystemTimeZoneById("SE Asia Standard Time");
        public readonly DatVeDbContext _datVeDbContext;
        public readonly ILogger<BaseDatVeService> _logger;
        public readonly IHttpContextAccessor _httpContextAccessor;
        protected readonly IMapper _mapper;

        public BaseDatVeService(
            DatVeDbContext datVeDbContext,
            ILogger<BaseDatVeService> logger,
            IHttpContextAccessor httpContextAccessor,
            IMapper mapper
        )
        {
            _datVeDbContext = datVeDbContext;
            _logger = logger;
